...
class DashboardController extends BaseController
{
     ...
     * クライアント別パフォーマンスの取得
     */
    private function getClientPerformance(array $dateRange): array
    {
        $sql = "SELECT 
                    c.id,
                    c.company_name,
     ...
     * プラットフォーム別統計の取得
     */
    private function getPlatformStats(array $dateRange): array
    {
        $sql = "SELECT 
                    aa.platform,
                    COUNT(DISTINCT aa.id) as account_count,
     ...
     * 日別トレンドの取得
     */
    private function getDailyTrend(array $dateRange): array
    {
        $sql = "SELECT 
                    dad.date_value,
     ...
     * 日付差分を計算
     */
    private function getDateDiff(array $dateRange): int
    {
