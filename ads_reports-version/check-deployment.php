                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h3 class="mb-0">
                            ...
                            広告管理システム - デプロイメント確認 (ads_reports)
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <?php if ($overallStatus): ?>
                                <div class="alert alert-info">
                                    <h6>✅ デプロイメント完了！</h6>
                                    <ul class="mb-0">
                                        <li><a href="/ads_reports/" target="_blank">メインページにアクセス</a></li>
                                        <li><a href="/ads_reports/clients" target="_blank">クライアント管理画面を確認</a></li>
                                        <li><a href="/ads_reports/api/dashboard/data" target="_blank">API動作を確認</a></li>
